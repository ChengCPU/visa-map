    ...
    <table cellSpacing="0" cellPadding="0">
          ...
          <th></th>
				...
				<tr className={styles.subRow}>
					...
					<td className={styles.text}>2</td>
					<td className={styles.text}>3</td>
					<td className={styles.text}>4</td>
					<td className={styles.text}>5</td>
					<td className={styles.text}>6</td>
					<td className={styles.text}>7</td>
					<td className={styles.text}>8</td>
					<td className={styles.text}>9</td>
          <td className={styles.text}>10</td>
				</tr>
				<tr className={styles.subRow}>
