...
export default function Home() {
  ...
  const [selectArray, setSelectArray] = useState(selections) //selectArray keeps track of which passport is currently selected
  const [assignedColors, setAssignedColors] = useState([colors,colors,colors,colors,colors,colors,colors,colors,colors,colors,colors]) //selector button-specific colors
  const [priority, setPriority] = useState(colors)
