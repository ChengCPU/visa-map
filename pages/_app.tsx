...
function MyApp({ Component, pageProps }) {
  ...
  const dimensionsProvider:{[key:string]:number} = {width:dimensions.width,height:dimensions.height}
  const countrySelectProvider:{[key:string]:Function} = {setCountrySelect:setCountrySelect}
  const proToggleProvider:{[key:string]:boolean|Function} = {proToggle:proToggle,setProToggle:setProToggle}
