...
function MyApp({ Component, pageProps }) {
  ...
  const [windowSize, setWindowSize] = useState<any>({height: null, width: null})
  ...
  const diffProvider:any = {
    abkhaziaDiff: diff.abkhaziaColor,
    afghanistanDiff: diff.afghanistanColor,
    albaniaDiff: diff.albaniaColor,
    algeriaDiff: diff.algeriaColor,
    americanSamoaDiff: diff.americanSamoaColor,
    andorraDiff: diff.andorraColor,
    angolaDiff: diff.angolaColor,
    anguillaDiff: diff.anguillaColor,
    antiguaAndBarbudaDiff: diff.antiguaAndBarbudaColor,
    argentinaDiff: diff.argentinaColor,
    armeniaDiff: diff.armeniaColor,
    arubaDiff: diff.arubaColor,
    australiaDiff: diff.australiaColor,
    austriaDiff: diff.austriaColor,
    azerbaijanDiff: diff.azerbaijanColor,
    bahamasDiff: diff.bahamasColor,
    bahrainDiff: diff.bahrainColor,
    bangladeshDiff: diff.bangladeshColor,
    barbadosDiff: diff.barbadosColor,
    belarusDiff: diff.belarusColor,
    belgiumDiff: diff.belgiumColor,
    belizeDiff: diff.belizeColor,
    beninDiff: diff.beninColor,
    bermudaDiff: diff.bermudaColor,
    bhutanDiff: diff.bhutanColor,
    boliviaDiff: diff.boliviaColor,
    bonaireDiff: diff.bonaireColor,
    bosniaAndHerzegovinaDiff: diff.bosniaAndHerzegovinaColor,
    botswanaDiff: diff.botswanaColor,
    bouvetIslandDiff: diff.bouvetIslandColor,
    brazilDiff: diff.brazilColor,
    britishIndianOceanTerritoryDiff: diff.britishIndianOceanTerritoryColor,
    britishVirginIslandsDiff: diff.britishVirginIslandsColor,
    bruneiDiff: diff.bruneiColor,
    bulgariaDiff: diff.bulgariaColor,
    burkinaFasoDiff: diff.burkinaFasoColor,
    burundiDiff: diff.burundiColor,
    cambodiaDiff: diff.cambodiaColor,
    cameroonDiff: diff.cameroonColor,
    canadaDiff: diff.canadaColor,
    capeVerdeDiff: diff.capeVerdeColor,
    caymanIslandsDiff: diff.caymanIslandsColor,
    centralAfricanRepublicDiff: diff.centralAfricanRepublicColor,
    chadDiff: diff.chadColor,
    chileDiff: diff.chileColor,
    chinaDiff: diff.chinaColor,
    colombiaDiff: diff.colombiaColor,
    comorosDiff: diff.comorosColor,
    cookIslandsDiff: diff.cookIslandsColor,
    costaRicaDiff: diff.costaRicaColor,
    croatiaDiff: diff.croatiaColor,
    cubaDiff: diff.cubaColor,
    curacaoDiff: diff.curacaoColor,
    cyprusDiff: diff.cyprusColor,
    czechRepublicDiff: diff.czechRepublicColor,
    democraticRepublicOfTheCongoDiff: diff.democraticRepublicOfTheCongoColor,
    denmarkDiff: diff.denmarkColor,
    djiboutiDiff: diff.djiboutiColor,
    dominicaDiff: diff.dominicaColor,
    dominicanRepublicDiff: diff.dominicanRepublicColor,
    eastTimorDiff: diff.eastTimorColor,
    ecuadorDiff: diff.ecuadorColor,
    egyptDiff: diff.egyptColor,
    elSalvadorDiff: diff.elSalvadorColor,
    equatorialGuineaDiff: diff.equatorialGuineaColor,
    eritreaDiff: diff.eritreaColor,
    estoniaDiff: diff.estoniaColor,
    eswatiniDiff: diff.eswatiniColor,
    ethiopiaDiff: diff.ethiopiaColor,
    falklandIslandsDiff: diff.falklandIslandsColor,
    faroeIslandsDiff: diff.faroeIslandsColor,
    fijiDiff: diff.fijiColor,
    finlandDiff: diff.finlandColor,
    franceDiff: diff.franceColor,
    frenchGuianaDiff: diff.frenchGuianaColor,
    frenchPolynesiaDiff: diff.frenchPolynesiaColor,
    gabonDiff: diff.gabonColor,
    gambiaDiff: diff.gambiaColor,
    georgiaDiff: diff.georgiaColor,
    germanyDiff: diff.germanyColor,
    ghanaDiff: diff.ghanaColor,
    gibraltarDiff: diff.gibraltarColor,
    greeceDiff: diff.greeceColor,
    greenlandDiff: diff.greenlandColor,
    grenadaDiff: diff.grenadaColor,
    guadeloupeDiff: diff.guadeloupeColor,
    guamDiff: diff.guamColor,
    guatemalaDiff: diff.guatemalaColor,
    guernseyDiff: diff.guernseyColor,
    guineaDiff: diff.guineaColor,
    guineaBissauDiff: diff.guineaBissauColor,
    guyanaDiff: diff.guyanaColor,
    haitiDiff: diff.haitiColor,
    heardIslandAndMcDonaldIslandsDiff: diff.heardIslandAndMcDonaldIslandsColor,
    hondurasDiff: diff.hondurasColor,
    hongKongDiff: diff.hongKongColor,
    hungaryDiff: diff.hungaryColor,
    icelandDiff: diff.icelandColor,
    indiaDiff: diff.indiaColor,
    indonesiaDiff: diff.indonesiaColor,
    iranDiff: diff.iranColor,
    iraqDiff: diff.iraqColor,
    irelandDiff: diff.irelandColor,
    isleOfManDiff: diff.isleOfManColor,
    israelDiff: diff.israelColor,
    italyDiff: diff.italyColor,
    ivoryCoastDiff: diff.ivoryCoastColor,
    jamaicaDiff: diff.jamaicaColor,
    janMayenDiff: diff.janMayenColor,
    japanDiff: diff.japanColor,
    jerseyDiff: diff.jerseyColor,
    jordanDiff: diff.jordanColor,
    kazakhstanDiff: diff.kazakhstanColor,
    kenyaDiff: diff.kenyaColor,
    kiribatiDiff: diff.kiribatiColor,
    kosovoDiff: diff.kosovoColor,
    kuwaitDiff: diff.kuwaitColor,
    kyrgyzstanDiff: diff.kyrgyzstanColor,
    laosDiff: diff.laosColor,
    latviaDiff: diff.latviaColor,
    lebanonDiff: diff.lebanonColor,
    lesothoDiff: diff.lesothoColor,
    liberiaDiff: diff.liberiaColor,
    libyaDiff: diff.libyaColor,
    liechtensteinDiff: diff.liechtensteinColor,
    lithuaniaDiff: diff.lithuaniaColor,
    luxembourgDiff: diff.luxembourgColor,
    macaoDiff: diff.macaoColor,
    madagascarDiff: diff.madagascarColor,
    malawiDiff: diff.malawiColor,
    malaysiaDiff: diff.malaysiaColor,
    maldivesDiff: diff.maldivesColor,
    maliDiff: diff.maliColor,
    maltaDiff: diff.maltaColor,
    marshallIslandsDiff: diff.marshallIslandsColor,
    martiniqueDiff: diff.martiniqueColor,
    mauritaniaDiff: diff.mauritaniaColor,
    mauritiusDiff: diff.mauritiusColor,
    mayotteDiff: diff.mayotteColor,
    mexicoDiff: diff.mexicoColor,
    micronesiaDiff: diff.micronesiaColor,
    moldovaDiff: diff.moldovaColor,
    monacoDiff: diff.monacoColor,
    mongoliaDiff: diff.mongoliaColor,
    montenegroDiff: diff.montenegroColor,
    montserratDiff: diff.montserratColor,
    moroccoDiff: diff.moroccoColor,
    mozambiqueDiff: diff.mozambiqueColor,
    myanmarDiff: diff.myanmarColor,
    namibiaDiff: diff.namibiaColor,
    nauruDiff: diff.nauruColor,
    nepalDiff: diff.nepalColor,
    netherlandsDiff: diff.netherlandsColor,
    newCaledoniaDiff: diff.newCaledoniaColor,
    newZealandDiff: diff.newZealandColor,
    nicaraguaDiff: diff.nicaraguaColor,
    nigerDiff: diff.nigerColor,
    nigeriaDiff: diff.nigeriaColor,
    niueDiff: diff.niueColor,
    norfolkIslandDiff: diff.norfolkIslandColor,
    northernCyprusDiff: diff.northernCyprusColor,
    northernMarianaIslandsDiff: diff.northernMarianaIslandsColor,
    northKoreaDiff: diff.northKoreaColor,
    northMacedoniaDiff: diff.northMacedoniaColor,
    norwayDiff: diff.norwayColor,
    omanDiff: diff.omanColor,
    pakistanDiff: diff.pakistanColor,
    palauDiff: diff.palauColor,
    palestineDiff: diff.palestineColor,
    panamaDiff: diff.panamaColor,
    papuaNewGuineaDiff: diff.papuaNewGuineaColor,
    paraguayDiff: diff.paraguayColor,
    peruDiff: diff.peruColor,
    philippinesDiff: diff.philippinesColor,
    pitcairnIslandsDiff: diff.pitcairnIslandsColor,
    polandDiff: diff.polandColor,
    portugalDiff: diff.portugalColor,
    qatarDiff: diff.qatarColor,
    republicOfTheCongoDiff: diff.republicOfTheCongoColor,
    reunionDiff: diff.reunionColor,
    romaniaDiff: diff.romaniaColor,
    russiaDiff: diff.russiaColor,
    rwandaDiff: diff.rwandaColor,
    sabaDiff: diff.sabaColor,
    saintBarthelemyDiff: diff.saintBarthelemyColor,
    saintHelenaDiff: diff.saintHelenaColor,
    saintKittsAndNevisDiff: diff.saintKittsAndNevisColor,
    saintLuciaDiff: diff.saintLuciaColor,
    saintMartinDiff: diff.saintMartinColor,
    saintPierreAndMiquelonDiff: diff.saintPierreAndMiquelonColor,
    saintVincentAndTheGrenadinesDiff: diff.saintVincentAndTheGrenadinesColor,
    samoaDiff: diff.samoaColor,
    sanMarinoDiff: diff.sanMarinoColor,
    saoTomeAndPrincipeDiff: diff.saoTomeAndPrincipeColor,
    saudiArabiaDiff: diff.saudiArabiaColor,
    senegalDiff: diff.senegalColor,
    serbiaDiff: diff.serbiaColor,
    seychellesDiff: diff.seychellesColor,
    sierraLeoneDiff: diff.sierraLeoneColor,
    singaporeDiff: diff.singaporeColor,
    sintEustatiusDiff: diff.sintEustatiusColor,
    sintMaartenDiff: diff.sintMaartenColor,
    slovakiaDiff: diff.slovakiaColor,
    sloveniaDiff: diff.sloveniaColor,
    solomonIslandsDiff: diff.solomonIslandsColor,
    somaliaDiff: diff.somaliaColor,
    southAfricaDiff: diff.southAfricaColor,
    southGeorgiaAndTheSouthSandwichIslandsDiff: diff.southGeorgiaAndTheSouthSandwichIslandsColor,
    southKoreaDiff: diff.southKoreaColor,
    southOssetiaDiff: diff.southOssetiaColor,
    southSudanDiff: diff.southSudanColor,
    spainDiff: diff.spainColor,
    sriLankaDiff: diff.sriLankaColor,
    sudanDiff: diff.sudanColor,
    surinameDiff: diff.surinameColor,
    svalbardDiff: diff.svalbardColor,
    swedenDiff: diff.swedenColor,
    switzerlandDiff: diff.switzerlandColor,
    syriaDiff: diff.syriaColor,
    taiwanDiff: diff.taiwanColor,
    tajikistanDiff: diff.tajikistanColor,
    tanzaniaDiff: diff.tanzaniaColor,
    thailandDiff: diff.thailandColor,
    togoDiff: diff.togoColor,
    tokelauDiff: diff.tokelauColor,
    tongaDiff: diff.tongaColor,
    transnistriaDiff: diff.transnistriaColor,
    trinidadAndTobagoDiff: diff.trinidadAndTobagoColor,
    tunisiaDiff: diff.tunisiaColor,
    turkeyDiff: diff.turkeyColor,
    turkmenistanDiff: diff.turkmenistanColor,
    turksAndCaicosDiff: diff.turksAndCaicosColor,
    tuvaluDiff: diff.tuvaluColor,
    ugandaDiff: diff.ugandaColor,
    ukraineDiff: diff.ukraineColor,
    unitedArabEmiratesDiff: diff.unitedArabEmiratesColor,
    unitedKingdomDiff: diff.unitedKingdomColor,
    unitedStatesDiff: diff.unitedStatesColor,
    unitedStatesVirginIslandsDiff: diff.unitedStatesVirginIslandsColor,
    uruguayDiff: diff.uruguayColor,
    uzbekistanDiff: diff.uzbekistanColor,
    vanuatuDiff: diff.vanuatuColor,
    vaticanCityDiff: diff.vaticanCityColor,
    venezuelaDiff: diff.venezuelaColor,
    vietnamDiff: diff.vietnamColor,
    wallisAndFutunaDiff: diff.wallisAndFutunaColor,
    westernSaharaDiff: diff.westernSaharaColor,
    yemenDiff: diff.yemenColor,
    zambiaDiff: diff.zambiaColor,
    zimbabweDiff: diff.zimbabweColor
  }

  useEffect(() => {
    fetchWindowSize(setWindowSize, setMobile)
