...
function MyApp({ Component, pageProps }) {
  ...
  useEffect(() => {
    if(selectArray[select.selection] != null && selectArray[select.selection] != select.passport) { reset(setAssignedColors, priorityRef, setTempPriority, secondToggle, setSecondToggle, setDiff, setTempDiff); return }
