...
import sovereignMilitaryOrderOfMalta from '/public/passports/sovereignMilitaryOrderOfMalta.webp'
...
import westernSahara from '/public/passports/westernSahara.webp'
...
function MyApp({ Component, pageProps }) {
  ...
  const passportDataRef = useRef<Array<[string|number]>>([])
  ...
  return (
    ...
    <DimensionsContext.Provider value={dimensionsProvider}>
      <Component {...pageProps}
        ...
        passportDataRef={passportDataRef}
      />
      <Selector
        Drawer={Drawer}
