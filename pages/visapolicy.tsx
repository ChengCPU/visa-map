...
const VisaPolicy:React.FC<Props> = ({ setHover, priorityRef, setSelectorLoad, tempPriorityRef, diffRef, setTempDiff, mousePos, hover, countrySelect }) => {
