...
const VisaPolicy:React.FC<Props> = ({ setHover, priority, setPriority, setSelectorLoad, setTempPriority, diff, setDiff, setTempDiff, mousePos, hover, countrySelect }) => {
          ...
          {filterValue && (
            filteredOptions.map((option, index) => (
              <p className={'inputText'} onClick={() => {
                ...
                individualVisaPolicyCalculation(countriesAndTerritories[options.indexOf(option)], setPriority, selected)
                setFilterValue('')
                setDisplay(true)
