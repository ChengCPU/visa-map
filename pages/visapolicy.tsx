...
const VisaPolicy:React.FC<Props> = ({ setHover, priorityRef, setSelectorLoad, setTempPriority, diff, setDiff, setTempDiff, mousePos, hover, countrySelect }) => {
  ...
  useEffect(() => {
    ...
    setTempPriority(priorityRef.current)
