    ...
    return (
      ...
      <div className={styles.progressBarsContainer}>
        <div className={styles.textSeparator}>
          <p className={styles.textDiv}>{languageCalculation[dataSize - 2] + unsortedData[index]?.[6]}</p>
          <div className={styles.separator}></div>
          <p className={styles.textDiv}>{languageCalculation[dataSize - 3] + unsortedData[index]?.[8].toLocaleString()}</p>
        </div>
        ...
        <br/>
        <br/>
        <p className={styles.textDiv}>{languageCalculation[dataSize - 4] + unsortedData[index]?.[7]}</p>
        <div className={styles.progressBarDesktop}>
        ...
        <tr>
          ...
          <td>
            ...
            <Compare
              ...
              text={languageCalculation[dataSize - 1]}
            />
            }
            {compareToggle &&
            <div>
