...
export default function diffCalculation(selectArrayRef:any, assignedColorsRef:any, diffRef:any) {
  ...
  for(let x = 0; x < colors.length; x++) {
    ...
    if(assignedColorsRef.current[0][colors[x]] != 2 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[y()][colors[x]] == 2) {diffObject[countryCodes[x]] = 1; continue}
    //Mercosur freedom of movement
    if(assignedColorsRef.current[0][colors[x]] != 3 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[y()][colors[x]] == 3) {diffObject[countryCodes[x]] = 1; continue}
    //EU freedom of movement
    if(assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[y()][colors[x]] == 4) {diffObject[countryCodes[x]] = 1; continue}
    //GCC freedom of movement
    if(assignedColorsRef.current[0][colors[x]] != 5 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[y()][colors[x]] == 5) {diffObject[countryCodes[x]] = 1; continue}
    //Freedom of movement
    if(assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[y()][colors[x]] == 6) {diffObject[countryCodes[x]] = 1; continue}
    // VoA + E-visa
    if(assignedColorsRef.current[0][colors[x]] == 9 && assignedColorsRef.current[y()][colors[x]] == 10) {diffObject[countryCodes[x]] = 1; continue}
    // E-visa + VoA
    if(assignedColorsRef.current[0][colors[x]] == 10 && assignedColorsRef.current[y()][colors[x]] == 9) {diffObject[countryCodes[x]] = 1; continue}
    //visa free
    if(assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[0][colors[x]] != 5 && assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[0][colors[x]] != 3 && assignedColorsRef.current[0][colors[x]] != 2 && assignedColorsRef.current[y()][colors[x]] == 7) {diffObject[countryCodes[x]] = 1; continue}
    //visa on arrival/evisa
    if(assignedColorsRef.current[0][colors[x]] != 8 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[0][colors[x]] != 5 && assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[0][colors[x]] != 3 && assignedColorsRef.current[0][colors[x]] != 2 && assignedColorsRef.current[y()][colors[x]] == 8) {diffObject[countryCodes[x]] = 1; continue}
    //visa on arrival
    if(assignedColorsRef.current[0][colors[x]] != 9 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 8 && assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[0][colors[x]] != 5 && assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[0][colors[x]] != 3 && assignedColorsRef.current[0][colors[x]] != 2 && assignedColorsRef.current[y()][colors[x]] == 9) {diffObject[countryCodes[x]] = 1; continue}
    //evisa
    if(assignedColorsRef.current[0][colors[x]] != 10 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 9 && assignedColorsRef.current[0][colors[x]] != 8 && assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[0][colors[x]] != 5 && assignedColorsRef.current[0][colors[x]] != 4 && assignedColorsRef.current[0][colors[x]] != 3 && assignedColorsRef.current[0][colors[x]] != 2 && assignedColorsRef.current[y()][colors[x]] == 10) {diffObject[countryCodes[x]] = 1; continue}
    //special permit
    if(assignedColorsRef.current[0][colors[x]] != 11 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 10 && assignedColorsRef.current[0][colors[x]] != 9 && assignedColorsRef.current[0][colors[x]] != 8 && assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[y()][colors[x]] == 11) {diffObject[countryCodes[x]] = 1; continue}
    //simplified visa
    if(assignedColorsRef.current[0][colors[x]] != 12 && assignedColorsRef.current[0][colors[x]] != 0 && assignedColorsRef.current[0][colors[x]] != 11 && assignedColorsRef.current[0][colors[x]] != 10 && assignedColorsRef.current[0][colors[x]] != 9 && assignedColorsRef.current[0][colors[x]] != 8 && assignedColorsRef.current[0][colors[x]] != 7 && assignedColorsRef.current[0][colors[x]] != 6 && assignedColorsRef.current[y()][colors[x]] == 12) {diffObject[countryCodes[x]] = 1; continue}
  }
