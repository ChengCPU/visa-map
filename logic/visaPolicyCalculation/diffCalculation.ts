...
export default function diffCalculation(selectArrayRef:MutableRefObject<(null|string)[]>,assignedColorsRef:MutableRefObject<{[key:string]:number}[]>,diffRef:MutableRefObject<{[key:string]:number}>) {
  let diffObject:{[key:string]:number}
  ...
  for(let x = 0; x < ISOcodes.length; x++) {
    ...
    // VoA + E-visa
    if(assignedColorsRef.current[0][ISOcodes[x]] == 10 && assignedColorsRef.current[y()][ISOcodes[x]] == 11) {diffObject[ISOcodes[x]] = 1; continue}
    // E-visa + VoA
    if(assignedColorsRef.current[0][ISOcodes[x]] == 11 && assignedColorsRef.current[y()][ISOcodes[x]] == 10) {diffObject[ISOcodes[x]] = 1; continue}
    //visa free
    ...
    //evisa
    if(assignedColorsRef.current[0][ISOcodes[x]] != 11 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 10 && assignedColorsRef.current[0][ISOcodes[x]] != 9 && assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[0][ISOcodes[x]] != 5 && assignedColorsRef.current[0][ISOcodes[x]] != 4 && assignedColorsRef.current[0][ISOcodes[x]] != 3 && assignedColorsRef.current[0][ISOcodes[x]] != 2 && assignedColorsRef.current[y()][ISOcodes[x]] == 11) {diffObject[ISOcodes[x]] = 1; continue}
    //special permit
