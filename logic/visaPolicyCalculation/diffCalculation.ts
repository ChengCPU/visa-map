...
export default function diffCalculation(selectArrayRef:any, assignedColorsRef:any, diffRef:any) {
  ...
  for(let x = 0; x < ISOcodes.length; x++) {
    ...
    if(assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[0][ISOcodes[x]] != 5 && assignedColorsRef.current[0][ISOcodes[x]] != 4 && assignedColorsRef.current[0][ISOcodes[x]] != 3 && assignedColorsRef.current[0][ISOcodes[x]] != 2 && assignedColorsRef.current[y()][ISOcodes[x]] == 15) {diffObject[ISOcodes[x]] = 1; continue}
    //visa on arrival/evisa
    if(assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[0][ISOcodes[x]] != 5 && assignedColorsRef.current[0][ISOcodes[x]] != 4 && assignedColorsRef.current[0][ISOcodes[x]] != 3 && assignedColorsRef.current[0][ISOcodes[x]] != 2 && assignedColorsRef.current[y()][ISOcodes[x]] == 8) {diffObject[ISOcodes[x]] = 1; continue}
    //visa on arrival
    if(assignedColorsRef.current[0][ISOcodes[x]] != 9 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[0][ISOcodes[x]] != 5 && assignedColorsRef.current[0][ISOcodes[x]] != 4 && assignedColorsRef.current[0][ISOcodes[x]] != 3 && assignedColorsRef.current[0][ISOcodes[x]] != 2 && assignedColorsRef.current[y()][ISOcodes[x]] == 9) {diffObject[ISOcodes[x]] = 1; continue}
    //evisa
    if(assignedColorsRef.current[0][ISOcodes[x]] != 10 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 9 && assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[0][ISOcodes[x]] != 5 && assignedColorsRef.current[0][ISOcodes[x]] != 4 && assignedColorsRef.current[0][ISOcodes[x]] != 3 && assignedColorsRef.current[0][ISOcodes[x]] != 2 && assignedColorsRef.current[y()][ISOcodes[x]] == 10) {diffObject[ISOcodes[x]] = 1; continue}
    //special permit
    if(assignedColorsRef.current[0][ISOcodes[x]] != 11 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 10 && assignedColorsRef.current[0][ISOcodes[x]] != 9 && assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[y()][ISOcodes[x]] == 11) {diffObject[ISOcodes[x]] = 1; continue}
    //simplified visa
    if(assignedColorsRef.current[0][ISOcodes[x]] != 12 && assignedColorsRef.current[0][ISOcodes[x]] != 0 && assignedColorsRef.current[0][ISOcodes[x]] != 11 && assignedColorsRef.current[0][ISOcodes[x]] != 10 && assignedColorsRef.current[0][ISOcodes[x]] != 9 && assignedColorsRef.current[0][ISOcodes[x]] != 8 && assignedColorsRef.current[0][ISOcodes[x]] != 15 && assignedColorsRef.current[0][ISOcodes[x]] != 7 && assignedColorsRef.current[0][ISOcodes[x]] != 6 && assignedColorsRef.current[y()][ISOcodes[x]] == 12) {diffObject[ISOcodes[x]] = 1; continue}
  }
