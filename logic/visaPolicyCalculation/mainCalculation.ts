...
export default function mainCalculation(country:string, assignedColors:object[], setAssignedColors:Function, select:Select, priorityRef:any, selectArray:null | string[], diffRef:any, setPercentage:Function) {
