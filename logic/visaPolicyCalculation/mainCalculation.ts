...
export default function mainCalculation(country:string, assignedColors:object[], setAssignedColors:Function, select:Select, priority:object, setPriority:Function, rerender:boolean, setRerender:Function, selectArray:null | string[], diff:object, setDiff:Function, setPercentage:Function) {
