...
export default function mainCalculation(enableDiffCalculation:boolean, country:string, assignedColorsRef:any, selectRef:any, priorityRef:any, selectArrayRef:any, diffRef:any, setPercentage:Function) {
