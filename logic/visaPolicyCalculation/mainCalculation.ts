...
export default function mainCalculation(country:string, assignedColorsRef:any, selectRef:any, priorityRef:any, selectArrayRef:any, diffRef:any, setPercentage:Function) {
