...
export default function fetchSortData(rankRef:any, num:number, sort:string) {
  ...
  switch(num) {
    ...
    case 5: visaFreeAreaSort(rankData, rankRef, sort); break
  }
}