...
export default function fetchSortData(visaPolicyData:any, setRankRender:Function, num:number, sort:string) {
  ...
  .then((data) => {
    ...
    visaPolicyData.current = rankData
    ...
    switch(num) {
      ...
      case 4: freedomOfMovementSort(rankData, setRankRender, sort); break;
    }
  })
}