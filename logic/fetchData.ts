...
export default function fetchData(setVisaPolicyData:Function, setRankRender:Function, num:number) {
  ...
  .then((data) => {
    ...
    switch(num) {
      case 1: insertionSort(rankData, setRankRender); break;
      case 2: visaFreeSort(rankData, setRankRender); break;
    }
  })
}