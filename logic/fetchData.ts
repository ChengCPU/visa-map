...
export default function fetchData(setVisaPolicyData:Function, setRankRender:Function, num:number, sort:string) {
  ...
  .then((data) => {
    ...
    switch(num) {
      case 1: insertionSort(rankData, setRankRender, sort); break;
