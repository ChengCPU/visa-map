...
export default function tableDataCalculation(assignedColors:object[], tableData:any, setTableData: Function, a:number) {
  switch(assignedColors[a][colors[a]]) {
    case 7: setTableData(tableData, tableData[a][a] = "Visa-free")
  }
}