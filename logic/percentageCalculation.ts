...
export default function percentageCalculation(percentage: string, setPercentage:Function, priority:object, setPriority:Function, rerender:boolean, setRerender:Function, x:number) {
