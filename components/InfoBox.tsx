...
const InfoBox:React.FC<Props> = ({ mousePosRef, hover, countrySelect, priorityRef }) => {
  ...
  return (
    ...
    .infoBox {
      ...
      position: absolute;
      left: ${mousePosRef.current[0] + 5 + 'px'};
      top: ${mousePosRef.current[1] + 5 + 'px'};
      border-radius: 8px;
      border-color: black;
      border-style: solid;
      border-width: 2px;
