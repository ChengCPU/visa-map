...
const SelectorButtonContainer:React.FC<Props> = ({ setOpenDrawer, selectRef, selectArrayRef, priorityRef, tempPriorityRef, assignedColorsRef, diffRef, percentage, setPercentage, selectorLoad, tempDiffRef, ESTAbanRef, visaDurationRef, assignedVisaDurationRef, setLegend }) => {
