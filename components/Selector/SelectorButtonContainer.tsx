...
const SelectorButtonContainer:React.FC<Props> = ({ setOpenDrawer, select, setSelect, selectArray, setSelectArray, priorityRef, tempPriorityRef, setAssignedColors, setDiff, percentage, setPercentage, selectorLoad, setTempDiff }) => {
