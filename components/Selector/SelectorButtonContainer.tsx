...
const SelectorButtonContainer:React.FC<Props> = ({ setOpenDrawer, selectRef, selectArrayRef, priorityRef, assignedColorsRef, diffRef, percentage, setPercentage, selectorLoad, ESTAbanRef, visaDurationRef, assignedVisaDurationRef, setLegend, tableDiffRef }) => {
