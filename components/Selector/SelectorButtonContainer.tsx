...
const SelectorButtonContainer:React.FC<Props> = ({ setOpenDrawer, select, setSelect, selectArray, setSelectArray, setPriority, setAssignedColors, setDiff, percentage, setPercentage, selectorLoad, setTempPriority, setTempDiff }) => {
