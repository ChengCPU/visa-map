...
const StatsPassport:React.FC<Props> = ({ selectArray, horizontalColumn }) => {
  ...
  return (
    (selectArray[horizontalColumn] == null) ? <StatsPassportSVG /> : <Passport image={passportCalculation()}/>
  )
}

export default StatsPassport