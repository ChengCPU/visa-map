...
const Tanzania:React.FC = () => {
  ...
  const { tanzaniaDiff } = useContext(DiffContext)
...
<g className={'tanzania'}>
  ...
  `}</style>
<defs>
  <pattern id="tz" x="0" y="0" width="1" height="1" viewBox="0 10 45 45">
    <image width="1500" height="1500" xlinkHref={gridCalculation(tanzaniaColor)}/>
  </pattern>
</defs>
{(tanzaniaDiff == 1) ?
