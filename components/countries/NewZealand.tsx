...
const NewZealand:React.FC = () => {
  ...
  const { newZealandDiff } = useContext(DiffContext)
...
<g className={'newZealand'} onMouseOver={() => setCountrySelect('newZealand')}>
  ...
  `}</style>
<defs>
  <pattern id="nz" x="0" y="0" width="1" height="1" viewBox="20 10 28 28">
    <image width="1500" height="1500" xlinkHref={gridCalculation(newZealandColor)}/>
  </pattern>
</defs>
{(newZealandDiff == 1) ?
<>
