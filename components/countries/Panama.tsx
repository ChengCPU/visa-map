...
const Panama:React.FC = () => {
  ...
  const { panamaDiff } = useContext(DiffContext)
...
<g className={'panama'}>
  ...
  `}</style>
<defs>
  <pattern id="pa" x="0" y="0" width="1" height="1" viewBox="20 0 10 10">
    <image width="1500" height="1500" xlinkHref={gridCalculation(panamaColor)}/>
  </pattern>
</defs>
{(panamaDiff == 1) ?
