...
const Guinea:React.FC = () => {
  ...
  const { guineaDiff } = useContext(DiffContext)
...
<g className={'guinea'}>
  ...
  `}</style>
<defs>
  <pattern id="gn" x="0" y="0" width="1" height="1" viewBox="10 0 23 23">
    <image width="1500" height="1500" xlinkHref={gridCalculation(guineaColor)}/>
  </pattern>
</defs>
{(guineaDiff == 1) ?
