...
const Somalia:React.FC = () => {
  ...
  const { somaliaDiff } = useContext(DiffContext)
...
<g className={'somalia'}>
  ...
  `}</style>
<defs>
  <pattern id="so" x="0" y="0" width="1" height="1" viewBox="0 20 40 40">
    <image width="1500" height="1500" xlinkHref={gridCalculation(somaliaColor)}/>
  </pattern>
</defs>
{(somaliaDiff == 1) ?
