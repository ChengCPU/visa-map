...
const France:React.FC = () => {
  ...
  const { fr } = useContext(ColorContext)
...
<g className={'france'} onMouseOver={() => setCountrySelect('france')}>
  ...
  `}</style>
<defs>
  <pattern id="fr" x="0" y="0" width="4" height="4" patternUnits="userSpaceOnUse">
...
{(FR == 1) ?
<>
<path fill="url(#fr)" d="M 1035.7 231.4 1034.2 236.3 1031.8 235 1030.5 230.8 1031.4 228.4 1034.6 226 1035.7 231.4 Z" stroke="black"/>
