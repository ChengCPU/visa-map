...
const Mongolia:React.FC = () => {
  ...
  const { mongoliaDiff } = useContext(DiffContext)
...
<g className={'mongolia'}>
  ...
  `}</style>
<defs>
  <pattern id="mn" x="0" y="0" width="1" height="1" viewBox="40 0 50 50">
    <image width="1500" height="1500" xlinkHref={gridCalculation(mongoliaColor)}/>
  </pattern>
</defs>
{(mongoliaDiff == 1) ?
