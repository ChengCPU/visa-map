...
const Azerbaijan:React.FC = () => {
  ...
  const { azerbaijanDiff } = useContext(DiffContext)
...
<g className={'azerbaijan'}>
  ...
  `}</style>
<defs>
  <pattern id="az" x="0" y="0" width="1" height="1" viewBox="0 0 20 20">
    <image width="1500" height="1500" xlinkHref={gridCalculation(azerbaijanColor)}/>
  </pattern>
</defs>
{(azerbaijanDiff == 1) ?
<>
