...
const India:React.FC = () => {
  ...
  const { indiaColor } = useContext(ColorContext)
  const { indiaDiff } = useContext(DiffContext)
...
<g className={'india'} onMouseOver={() => setCountrySelect('india')}>
  ...
  `}</style>
<defs>
  <pattern id="in" x="0" y="0" width="1" height="1" viewBox="0 20 115 115">
    <image width="1500" height="1500" xlinkHref={gridCalculation(indiaColor)}/>
  </pattern>
</defs>
{(indiaDiff == 1) ?
