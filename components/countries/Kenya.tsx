...
const Kenya:React.FC = () => {
  ...
  const { kenyaDiff } = useContext(DiffContext)
...
<g className={'kenya'}>
  ...
  `}</style>
<defs>
  <pattern id="ke" x="0" y="0" width="1" height="1" viewBox="0 20 33 33">
    <image width="1500" height="1500" xlinkHref={gridCalculation(kenyaColor)}/>
  </pattern>
</defs>
{(kenyaDiff == 1) ?
