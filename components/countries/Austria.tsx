...
const Austria:React.FC = () => {
  ...
  const { austriaDiff } = useContext(DiffContext)
...
<g className={'austria'}>
  ...
  `}</style>
<defs>
  <pattern id="at" x="0" y="0" width="1" height="1" viewBox="5 0 14 14">
    <image width="1500" height="1500" xlinkHref={gridCalculation(austriaColor)}/>
  </pattern>
</defs>
{(austriaDiff == 1) ?
