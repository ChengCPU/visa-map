...
const Kazakhstan:React.FC = () => {
  ...
  const { kazakhstanColor } = useContext(ColorContext)
  const { kazakhstanDiff } = useContext(DiffContext)

return (
<g className={'kazakhstan'}>
  <style jsx>{`
  .kazakhstan {
  ...
  `}</style>
<defs>
  <pattern id="kz" x="0" y="0" width="1" height="1" viewBox="50 0 70 70">
    <image width="1500" height="1500" xlinkHref={gridCalculation(kazakhstanColor)}/>
  </pattern>
</defs>
{(kazakhstanDiff == 1) ?
