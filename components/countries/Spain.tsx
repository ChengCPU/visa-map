...
const Spain:React.FC = () => {
  ...
  const { spainDiff } = useContext(DiffContext)
...
<g className={'spain'}>
  ...
  `}</style>
<defs>
  <pattern id="es" x="0" y="0" width="1" height="1" viewBox="10 0 40 40">
    <image width="1500" height="1500" xlinkHref={gridCalculation(spainColor)}/>
  </pattern>
</defs>
{(spainDiff == 1) ?
