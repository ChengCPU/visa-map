...
const Greece:React.FC = () => {
  ...
  const { gr } = useContext(ColorContext)
  const { GR } = useContext(DiffContext)
  const { setCountrySelect } = useContext(CountrySelectContext)

return (
<>
<g className={'greece'} onMouseOver={() => setCountrySelect('greece')}>
  <style jsx>{`
  .greece {
  fill: ${gr};
  stroke-width: 1;
...
<defs>
  ...
  <rect x="0" y="0" width="100%" height="100%" fill="url(#gr)" />
</defs>
{(GR == 1) ?
...
<g className={'greece'}>
  ...
  `}</style>
{(GR == 1) ?
<path fill="url(#gr)" d="M 1112.7 272.6 1115.8 274.8 1119.9 274.4 1123.9 274.8 1123.9 276 1126.7 275.2 1126.2 277.1 1118.6 277.6 1118.5 276.6 1111.9 275.3 1112.7 272.6 Z" stroke="black"/>
:
